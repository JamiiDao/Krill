...
pub enum KrillError {
    ...
    #[cfg(feature = "storage")]
    #[error("Unable to deserialize Supported Languages bytes. It's data is corrupted!")]
    UnableToDeserializeSupportedLanguages,
    ...
    #[cfg(feature = "storage")]
    #[error("The `SERVER_MAIL_CONNECTION` is already initialized.")]
